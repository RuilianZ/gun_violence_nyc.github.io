...
```
According to the plot, besides there is year on year to growth between 2019 to 2020, the distribution of shooting case across month are the same, which reinforce that the number of shooting cases is high is summer.
...
* Rrom 2006 to 2021, around 192 shooting cases actually happened near the CUIMC campus (from 158th to 176th St) . 
