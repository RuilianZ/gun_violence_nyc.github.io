...
* a report of the spatial, temporal analysis, and potential relation to other factors of the distribution of shooting incidents in NYC, including presenting the potential connection between shooting cases and COVID-19.
* a website with all the work and results presented.

# Related Work

Articles below are what mainly inspired our work:
...
* [Why Are Shootings And Murders On The Rise In NYC?](https://gothamist.com/news/why-are-shootings-and-murders-rise-nyc)

* [Gun Violence and COVID-19 in 2020](https://everytownresearch.org/report/gun-violence-and-covid-19-in-2020-a-year-of-colliding-crises/)
...
* [NYPD Shooting Incident(historic)](https://data.cityofnewyork.us/Public-Safety/NYPD-Shooting-Incident-Data-Historic-/833y-fsy8),
* [NYPD Shooting Incident(Year To Date)](https://data.cityofnewyork.us/Public-Safety/NYPD-Shooting-Incident-Data-Year-To-Date-/5ucz-vwe8),
...
All datasets were downloaded from [NYC open data](https://opendata.cityofnewyork.us/).
...
* `borough`: borough where the shooting incident occurred.
...
* `month`, `day`, `year`: specific day, month, and year of COVID-19 diagnosis.
* `borough`: borough where the case is confirmed.
* `borough_case_count`: total case count of COVID-19 in the borough of a given day.
* `total_case_count`: total case count of COVID-19 of a given day in NYC.
...
Set up and import NYPD shooting data and COVID-19 data.
...
### Using COVID Cases as Predictor

First we want to further explore that if there is a linear association between COVID cases and shooting incidents, so we fit a linear regression model for total COVID case with total shooting as predictor.
...
## What We Might Concern as CUIMC Students

* From 2006 to 2021, around 192 shooting cases actually happened near the CUIMC campus (from 158th to 176th St). 

## Tips for Staying Safe

* Columbia University Public Safety Resources  
  + Morningside: 212-854-5555 (emergency calls) or 212-854-2797 (main line)  
  + Manhattanville: 212-853-3333 (emergency calls) or 212-853-3301 (main line)  
  + Medical Center: 212-305-7979 (emergency calls) or 212-305-8100 (main line)  
* Local Resources  
  + New York City Police Department: Dial 911 in an emergency from any phone  
  + [NYC Office of Emergency Management](https://www1.nyc.gov/site/em/index.page)  
  + [NYC Department of Health and Mental Hygiene](https://www.health.ny.gov/health_care/medicaid/redesign/ehr/registry/nycdohmh.htm)  
* Please refer to this [Safety Tips](https://archive.nytimes.com/www.nytimes.com/fodors/top/features/travel/destinations/unitedstates/newyork/newyorkcity/fdrs_feat_111_8.html?n=Top%252FFeatures%252FTravel%252FDestinations%252FUnited%2520States%252FNew%2520York%252FNew%2520York%2520City) from The New York Times


**We hope everyone stay safe and healthy in NYC :)**
