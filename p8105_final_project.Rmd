...
perp_sex_race %>% 
  ...
  coord_polar(theta = "y") +
  scale_fill_brewer(palette = "Pastel1") +
  ggrepel::geom_label_repel(data = position,
...
We are also interested in the characteritics of victims.
...
vic_sex_race = 
  ...
  summarise(num = n()) %>% 
  mutate(perc = round(num/sum(num), digits = 3))
...
Most of the victims are Black (M: 71.8%, F: 68.6%), and the number of male victims in shooting cases is much more than female victims.
