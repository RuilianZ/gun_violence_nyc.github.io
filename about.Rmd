...
### Gun Shooting - Human Right Threat
...
## COVID-19 influence on shooting cases

```{r, echo=FALSE, out.width="70%", fig.cap="people with mask", fig.align = 'center'}
